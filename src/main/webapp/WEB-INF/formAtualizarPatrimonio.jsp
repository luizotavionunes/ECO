...
<div id="section">
	...
	<form action="patrimonio.do?acao=formatualiza" method="post">
		...
		<div class="formLab">Id:</div>
			...
			<div class="form">
				<input type="text" name="numero_serie" readonly="readonly" value="<%= Pat.getNumero_serie() %>" />
			</div>
			<br />
			<br />
			...
			<div class="form">
				<input type="text" name="descricao" readonly="readonly" value="<%= Pat.getDescricao_fabricante_modelo() %>"/>
			</div>
			<br />
			<br />
